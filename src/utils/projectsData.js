export const projectsData = {
      ...
      features: [
        {
          ...
          images: [
            'https://tylerhagan.co.uk/assets/img/offer-tool/ot-customerlist.png',
            'https://tylerhagan.co.uk/assets/img/offer-tool/ot-customer-add.png'
          ]
        },
        {
          title: 'Pitch Section',
        ...
        },
        {
          ...
          images: [
            'https://tylerhagan.co.uk/assets/img/offer-tool/ot-concept.png',
            'https://tylerhagan.co.uk/assets/img/offer-tool/ot-multi-site-offer.png',
            'https://tylerhagan.co.uk/assets/img/offer-tool/ot-configuration.jpg'
          ]
        },
        {
          ...
          images: ['https://tylerhagan.co.uk/assets/img/offer-tool/sidebars.png']
        }
      ]
    },
  ...
  'field-service': {
    ...
    definitionImage: 'https://tylerhagan.co.uk/assets/img/field-service/journey-map.png',
    solution: {
      objectives: [
      ...
      images: [
        { src: 'https://tylerhagan.co.uk/assets/img/field-service/preview-one.png', caption: 'Navigation and Dashboard' },
        { src: 'https://tylerhagan.co.uk/assets/img/field-service/preview-two.png', caption: 'Installation Checks and Photo Upload' },
        { src: 'https://tylerhagan.co.uk/assets/img/field-service/preview-three.png', caption: 'Preparation Checklist and Reports' }
      ]
    },
  ...
  'monitoring-app': {
    ...
    research: {
      ...
      wireframeImage: 'https://tylerhagan.co.uk/assets/img/eigen-app/top-level-wireframes-snippet-preview.png',
      flowImage: 'https://tylerhagan.co.uk/assets/img/eigen-app/user-flow.png'
    },
    design: {
      ...
      energyFlowImage: 'https://tylerhagan.co.uk/assets/img/eigen-app/energy-flow2x.jpg',
      prototypeImages: [
        { src: 'https://tylerhagan.co.uk/assets/img/eigen-app/early-prototype-dark-thumbnail.png', caption: 'Dashboard prototype (alpha test)' },
        { src: 'https://tylerhagan.co.uk/assets/img/eigen-app/early-prototype-light-thumbnail.png', caption: 'Daily graph prototype (beta test)' }
      ],
